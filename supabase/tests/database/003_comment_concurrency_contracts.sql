...
SELECT extensions.throws_ok(
  $$
    SELECT private.resolve_resume_comment_bootstrap_access_v1(
      'collaborator',
      NULL,
      NULL,
      NULL,
  ...
  '42501',
  'unauthorized',
  'collaborator bootstrap is retired'
);
...
SELECT extensions.ok(
  ...
  'no active cross-account collaboration lease survives migration'
);
